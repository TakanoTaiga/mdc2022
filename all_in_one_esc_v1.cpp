...
// pin setup
PwmOut V1_PWM(PA_10); //PC4 <- PA10 //PWM1/3
PwmOut V2_PWM(PA_1); //PA4 <- PA1 //PWM2/2
PwmOut V3_PWM(PB_2); //PWM2/4
PwmOut V4_PWM(PA_5); //PWM2/1

DigitalOut V1_Digital(PB_1);
DigitalOut V2_Digital(PB_0);
DigitalOut V3_Digital(PC_7);
DigitalOut V4_Digital(PC_6);
